...
const FrameComponent1: FunctionComponent = () => {
  return (
    <div className="self-stretch flex flex-row items-start justify-start pt-0 px-[72px] pb-[27px] box-border max-w-full text-left text-base text-gray-100 font-ibm-plex-sans mq725:pl-9 mq725:pr-9 mq725:box-border">
          ...
          <div className="w-[1040px] flex flex-col items-start justify-start gap-[12px] max-w-full">
            <div className="self-stretch flex flex-row items-start justify-between max-w-full gap-[20px] mq975:flex-wrap">
              ...
              <div className="flex flex-row items-start justify-start gap-[16px] text-mini text-black mq450:flex-wrap">
                <div className="rounded bg-whitesmoke-300 flex flex-row items-start justify-start py-[7px] pr-1.5 pl-3 gap-[10px]">
                ...
                <div className="rounded bg-royalblue flex flex-row items-start justify-start py-[7px] px-2.5 gap-[6px] text-white">
