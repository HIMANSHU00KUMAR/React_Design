...
const FrameComponent6: FunctionComponent = () => {
  return (
    <div className="absolute top-[0px] left-[200px] w-[692px] h-[430px] flex flex-col items-start justify-start pt-[198px] px-0 pb-8 box-border gap-[20px] max-w-full text-left text-lg text-black font-ibm-plex-sans mq450:h-auto">
      <div className="mt-[-240px] self-stretch flex flex-row items-start justify-start pt-[141px] px-0 pb-[58px] relative gap-[19.5px] text-base text-gray-100 mq450:flex-wrap">
        ...
        />
        <div className="h-px w-[1297px] absolute !m-[0] right-[-477px] bottom-[93px] box-border opacity-[0] z-[3] border-t-[1px] border-solid border-gainsboro-100" />
        <div className="relative text-black inline-block min-w-[93px] z-[3]">
          All Posts(32)
        </div>
        <div className="relative inline-block min-w-[47px] z-[3]">Article</div>
        <div className="relative inline-block min-w-[41px] z-[3]">Event</div>
        <div className="relative inline-block min-w-[72px] z-[3]">
          Education
        </div>
        <div className="relative inline-block min-w-[27px] z-[3]">Job</div>
      </div>
