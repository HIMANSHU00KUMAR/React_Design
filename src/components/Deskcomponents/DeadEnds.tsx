...
const DeadEnds: FunctionComponent = () => {
  return (
    <div className="flex-1 flex flex-col items-start justify-start gap-[16px] min-w-[450px] max-w-full text-left text-lg text-black font-ibm-plex-sans mq725:min-w-full">
      <FrameComponent
        networklet="/rectangle-5@2x.png"
        article="✍️ Article"
        whatIfFamousBrandsHadRegu="What if famous brands had regular fonts? Meet RegulaBrands!"
        logicGate="/rectangle-3@2x.png"
        sarthakKamra="Sarthak Kamra"
        group2="/group-2.svg"
      />
      <FrameComponent
        networklet="/rectangle-5-1@2x.png"
        article="🔬️ Education"
        whatIfFamousBrandsHadRegu="Tax Benefits for Investment under National Pension Scheme launched by Government"
        logicGate="/rectangle-3-1@2x.png"
        sarthakKamra="Sarah West"
        group2="/group-21@2x.png"
        propMinWidth="109px"
        propLineHeight="134.55%"
        propMinWidth1="390px"
        propOverflow="hidden"
        propMinWidth2="96px"
      />
      <div className="self-stretch rounded bg-white box-border flex flex-col items-start justify-start pt-0 px-0 pb-[18px] gap-[20px] max-w-full border-[1px] border-solid border-gainsboro-100">
        <div className="self-stretch h-[492px] relative rounded bg-white box-border hidden border-[1px] border-solid border-gainsboro-100" />
        <img
        ...
        <div className="self-stretch flex flex-row items-start justify-start py-0 px-5 box-border max-w-full">
          <div className="flex-1 flex flex-col items-start justify-start gap-[10px] max-w-full">
            <div className="relative font-medium inline-block min-w-[89px] z-[1]">
              🗓️ Meetup
            </div>
            <div className="self-stretch flex flex-col items-start justify-start gap-[4px] max-w-full text-3xl">
              <div className="self-stretch flex flex-row items-start justify-start gap-[15px] max-w-full mq725:flex-wrap">
                <div className="flex-1 flex flex-col items-start justify-start pt-px px-0 pb-0 box-border min-w-[390px] max-w-full mq725:min-w-full">
                  <div className="self-stretch relative font-semibold z-[1] mq450:text-lg">{`Finance & Investment Elite Social Mixer @Lujiazui`}</div>
                </div>
              ...
              <form className="m-0 self-stretch h-[102px] relative max-w-full">
                <div className="absolute top-[42px] left-[0px] rounded-lg bg-white box-border w-[652px] flex flex-row items-start justify-center py-[9px] px-5 max-w-full z-[1] border-[0.7px] border-solid border-darkgray-100">
                ...
                <img
                  ...
                  loading="lazy"
                  alt=""
                  src="/baselinetoday24px@2x.png"
                />
                <div className="absolute top-[0px] left-[492px] rounded bg-white shadow-[0px_2px_8px_rgba(0,_0,_0,_0.16),_0px_0px_2px_rgba(0,_0,_0,_0.08)] w-40 flex flex-col items-start justify-start py-1 px-0 box-border z-[2]">
                  <div className="self-stretch h-[102px] relative rounded bg-white shadow-[0px_2px_8px_rgba(0,_0,_0,_0.16),_0px_0px_2px_rgba(0,_0,_0,_0.08)] hidden z-[1]" />
                  <div className="self-stretch flex flex-row items-start justify-start py-[5px] px-3 z-[1] border-[1px] border-solid border-black">
                    ...
                    <div className="relative text-sm font-ibm-plex-sans text-black text-right inline-block min-w-[25px] z-[1]">
                      Edit
                    </div>
                  </div>
      ...
      <div className="self-stretch rounded bg-white box-border flex flex-col items-start justify-start py-[18px] px-[19px] gap-[32px] max-w-full border-[1px] border-solid border-gainsboro-100 mq725:gap-[16px]">
        <div className="w-[694px] h-[271px] relative rounded bg-white box-border hidden max-w-full border-[1px] border-solid border-gainsboro-100" />
          ...
          <div className="self-stretch flex flex-col items-end justify-start gap-[16px] max-w-full text-3xl">
            <div className="self-stretch flex flex-row items-start justify-start gap-[24px] max-w-full mq725:flex-wrap">
              <div className="flex-1 flex flex-col items-start justify-start gap-[12px] min-w-[390px] max-w-full mq725:min-w-full">
                <div className="self-stretch relative leading-[30px] font-semibold z-[1] mq450:text-lg mq450:leading-[24px]">
                  Software Developer
                </div>
            ...
            <div className="self-stretch rounded-3xs bg-white box-border flex flex-row items-start justify-center py-2 px-5 max-w-full z-[1] text-center text-smi text-mediumseagreen border-[0.7px] border-solid border-darkgray-100">
              ...
              <div className="relative leading-[140.4%] font-semibold inline-block min-w-[118px] z-[1]">
                Apply on Timesjobs
              </div>
            </div>
          </div>
