...
const MbFrameComponent: FunctionComponent = () => {
  return (
    <section className="self-stretch bg-white shadow-[0px_1px_2px_rgba(0,_0,_0,_0.12)] flex flex-col items-start justify-start py-5 px-4 box-border gap-[32px] max-w-full z-[1] text-left text-sm text-black font-ibm-plex-sans">
...
export default MbFrameComponent;
