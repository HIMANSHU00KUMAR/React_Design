...
const MbFrameComponent8: FunctionComponent = () => {
  return (
    <div className="self-stretch flex flex-col items-start justify-start gap-[19px] text-left text-lg text-black font-ibm-plex-sans">
      ...
      <div className="self-stretch flex flex-col items-start justify-start text-smi text-gray-100">
        <div className="self-stretch rounded-t-sm rounded-b-none bg-whitesmoke-200 flex flex-row items-start justify-start py-0 px-3 gap-[82px] shrink-0 [debug_commit:1de1738] z-[2] border-[1px] border-solid border-gainsboro-100">
        ...
        <div className="self-stretch bg-whitesmoke-200 flex flex-row items-start justify-start py-2.5 px-3 shrink-0 [debug_commit:1de1738] z-[1] mt-[-1px] border-[1px] border-solid border-gainsboro-100">
        ...
        <div className="self-stretch bg-whitesmoke-200 flex flex-row items-start justify-between py-2.5 px-[11px] shrink-0 [debug_commit:1de1738] gap-[20px] z-[2] mt-[-1px] border-[1px] border-solid border-gainsboro-100">
          <div className="h-10 w-80 relative bg-whitesmoke-200 box-border hidden border-[1px] border-solid border-gainsboro-100" />
        ...
        <div className="self-stretch rounded-t-none rounded-b-sm bg-whitesmoke-200 flex flex-row items-start justify-start py-2.5 px-3 shrink-0 [debug_commit:1de1738] whitespace-nowrap z-[1] mt-[-1px] border-[1px] border-solid border-gainsboro-100">
...
export default MbFrameComponent8;
