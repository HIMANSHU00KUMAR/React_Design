...
const MbFrameComponent2: FunctionComponent = () => {
  return (
    <section className="self-stretch bg-white shadow-[0px_1px_2px_rgba(0,_0,_0,_0.12)] flex flex-col items-start justify-start pt-0 px-0 pb-5 box-border gap-[14px] max-w-full z-[1] text-left text-sm text-black font-ibm-plex-sans">
        ...
        <div className="flex-1 flex flex-col items-start justify-start gap-[21px] max-w-full">
          <div className="self-stretch flex flex-col items-start justify-start gap-[13px]">
            <div className="self-stretch flex flex-col items-start justify-start gap-[6px]">
              <div className="w-[85px] h-[19px] relative font-medium inline-block z-[2]">
                <span>{`🔬️ `}</span>
...
export default MbFrameComponent2;
