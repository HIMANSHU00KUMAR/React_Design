...
const MbFrameComponent7: FunctionComponent = () => {
  return (
    <div className="self-stretch flex flex-row items-start justify-start py-0 pr-[18px] pl-4 box-border max-w-full text-left text-sm text-black font-ibm-plex-sans">
...
export default MbFrameComponent7;
