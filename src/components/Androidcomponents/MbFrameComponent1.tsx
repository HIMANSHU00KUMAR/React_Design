...
const MbFrameComponent1: FunctionComponent = () => {
  return (
    <section className="self-stretch h-[374px] bg-white shadow-[0px_1px_2px_rgba(0,_0,_0,_0.12)] flex flex-col items-start justify-start pt-3 px-0 pb-5 box-border gap-[14px] max-w-full z-[1] text-left text-sm text-black font-ibm-plex-sans">
...
export default MbFrameComponent1;
